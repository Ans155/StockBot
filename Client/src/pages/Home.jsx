...
const Home = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const data1 = {
      question: "tell me something about  meta",
      answer: "Meta is a technology company that builds technologies that help people connect, find communities, and grow businesses. It was founded in 2004 as Facebook, and has since expanded to include other apps like Messenger, Instagram, and WhatsApp. Meta is now moving beyond 2D screens toward immersive experiences like augmented and virtual reality to help build the next evolution in social technology.\n\nWant to know more ?\nWhat are the challenges that Meta faces in its efforts to move beyond 2D screens toward immersive experiences?",
    };
    if (!responseFromAPI) {
      if (inputPrompt.trim() !== "") {
                ...
                >
                  ...
                  <div className="botMessageMainContainer">
                    <div className="botMessageWrapper">
                      <Avatar>
                        <img src="./logo.png" width={35} height={35} alt="profile" />
                      </Avatar>
                      {/* <img src="./logo.png" width={0} height={50} alt="profile" ></img>  */}
                      {chat.botMessage ? (
                        <>
        ...
        <form onSubmit={handleSubmit}>
          <div className="inputPromptWrapper">
            <input
              ...
              type="text"
              rows="1"
              placeholder="Looking for stock data, including quarterly earnings, revenue, and growth metrics? Ask me your queries!"
              value={inputPrompt}
